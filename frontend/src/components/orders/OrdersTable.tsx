...
export const OrdersTable = ({ orders, onView, onEdit, onDelete }: Props) => {
  const getStatusDisplay = (order: Order) => {
    ...
    // For pending delivery orders, show "Pending Delivery"
    if (status === "pending" && isDelivery) {
      return {
    ...
    <div className="overflow-x-auto rounded-2xl border border-gray-100 bg-white">
      <table className="w-full text-left border-collapse">
        ...
        <tbody className="divide-y divide-gray-50">
          {orders.map((o) => {
            const statusDisplay = getStatusDisplay(o);
            ...
            return (
              ...
              >
                ...
                <td className="px-6 py-5">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-[10px] font-bold border ${getOrderTypeStyle(o.order_type)}`}>
                ...
                <td className="px-6 py-5">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-[11px] font-bold border ${statusDisplay.style}`}>
