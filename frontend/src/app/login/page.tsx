        ...
        <div className="min-h-screen flex bg-white font-[Outfit, sans-serif]">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-[#2563eb] relative items-center justify-center overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-10">
                    ...
                    <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-blue-300 rounded-full blur-[100px]"></div>
                </div>
                ...
                <div className="relative z-10 text-center px-12">
                    ...
                    <h2 className="text-5xl font-black text-white mb-6 tracking-tight">GrocerEase</h2>
                    <p className="text-blue-100 text-xl font-medium max-w-md mx-auto leading-relaxed">
                        Effortless grocery management for modern businesses. Scale faster, sell smarter.
                    </p>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <a href="#" className="text-xs text-blue-600 hover:text-blue-700 font-bold underline-offset-4 hover:underline">Forgot password?</a>
                            </div>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-blue-600 transition-colors">
                    ...
                    <div className="mt-10 pt-10 border-t border-gray-100 text-center">
                        <p className="text-gray-500 font-medium">
                            ...
                            <Link href="/register" className="text-blue-600 hover:text-blue-700 font-black ml-1 underline-offset-4 hover:underline">
                                Create for free
                            </Link>
                        </p>
                    </div>
